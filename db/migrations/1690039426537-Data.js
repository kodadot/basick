module.exports = class Data1690039426537 {
    name = 'Data1690039426537'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "collection_entity" ("block_number" numeric, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner" text NOT NULL, "hash" text NOT NULL, "id" character varying NOT NULL, "image" text, "issuer" text NOT NULL, "max" integer, "media" text, "metadata" text, "name" text, "type" character varying(7) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "meta_id" character varying, CONSTRAINT "PK_5d44e140c4fcb3d961f9e83405f" PRIMARY KEY ("id"))`)
